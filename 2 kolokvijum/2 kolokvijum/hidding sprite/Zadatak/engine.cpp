...
void Engine::run() {
    ...
    Sprite *sp = new HidingSprite(sheet); ///ovde stavljeno new HidingSprite umesto new Sprite (mozes i svaki Sprite da promenis u Hiding ali je ovo dovoljno
    sp->setFrameSkip(4);
